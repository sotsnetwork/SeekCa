      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8 overflow-hidden">
          ...
          <CardContent className="relative pt-0">
            <div className="flex flex-col md:flex-row md:items-end -mt-12 md:-mt-16 mb-4 md:mb-6">
              ...
              <div className="mt-3 md:mt-0 md:ml-6 md:pb-4">
                <div className="flex items-center flex-wrap">
                  <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mr-2 md:mr-3">{getFullName()}</h1>
                  ...
                  <Badge 
                    ...
                    className={`ml-2 text-xs h-5 ${professional.availability_status === 'available' ? 'bg-green-100 text-green-800' : ''}`}
                  >
                ...
                <div className="flex items-center mt-1 md:mt-2">
                  <Briefcase className="w-3 h-3 md:w-4 md:h-4 text-gray-500 mr-1" />
                  <p className="text-base md:text-lg text-gray-700">{professional.title || 'Professional'}</p>
                </div>
                <div className="flex items-center mt-1 md:mt-2">
                  <MapPin className="w-3 h-3 md:w-4 md:h-4 text-gray-500 mr-1" />
                  <p className="text-sm md:text-base text-gray-600">{professional.profiles?.location || 'Location not specified'}</p>
                </div>
              </div>
              ...
              <div className="mt-3 md:mt-0 flex flex-col items-end">
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-sm text-gray-600">({professional.total_reviews || 0} reviews)</span>
                </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-4 md:mb-6">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4">
            ...
            <TabsTrigger value="reviews" className="flex items-center">
              ...
              <span className="text-xs md:text-sm">Reviews ({professional.total_reviews || 0})</span>
            </TabsTrigger>
            <TabsTrigger value="portfolio" className="flex items-center col-span-2 md:col-span-1">
              <FileText className="w-3 h-3 md:w-4 md:h-4 mr-1 md:mr-2" />
              <span className="text-xs md:text-sm">Portfolio</span>
            </TabsTrigger>
            <TabsTrigger value="contact" className="hidden md:flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                  ...
                  <CardContent className="p-4 md:p-6">
                    {reviews.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        <MessageSquare className="h-10 w-10 md:h-12 md:w-12 text-gray-300 mx-auto mb-2 md:mb-3" />
                        <h3 className="text-base md:text-lg font-medium text-gray-900 mb-1">No Reviews Yet</h3>
                        <p className="text-sm md:text-base text-gray-600">This professional hasn't received any reviews yet.</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
              ...
              <div className="space-y-4 md:space-y-8">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center">
                      <Phone className="mr-2 h-4 w-4 md:h-5 md:w-5 text-green-600" />
                      Contact Information
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3 md:space-y-4">
                    {professional.profiles?.phone && (
                      <div className="flex items-center text-sm md:text-base">
                        <Phone className="w-4 h-4 md:w-5 md:h-5 text-gray-500 mr-2 md:mr-3" />
                        <span className="break-all">{professional.profiles.phone}</span>
                      </div>
                    )}
                    {professional.profiles?.email && (
                      <div className="flex items-center text-sm md:text-base">
                        <Mail className="w-4 h-4 md:w-5 md:h-5 text-gray-500 mr-2 md:mr-3" />
                        <span className="break-all">{professional.profiles.email}</span>
                      </div>
                    )}
                    {professional.profiles?.website && (
                      <div className="flex items-center text-sm md:text-base">
                        <Globe className="w-4 h-4 md:w-5 md:h-5 text-gray-500 mr-2 md:mr-3" />
                        <a 
                    ...
                    {professional.profiles?.linkedin_url && (
                      <div className="flex items-center text-sm md:text-base">
                        <Linkedin className="w-4 h-4 md:w-5 md:h-5 text-gray-500 mr-2 md:mr-3" />
                        <a 
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center">
                      <Calendar className="mr-2 h-4 w-4 md:h-5 md:w-5 text-blue-600" />
                      Availability
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="p-4 md:p-6">
