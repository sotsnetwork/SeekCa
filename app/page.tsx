    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center px-2">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-6 md:mb-8 max-w-3xl mx-auto">
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-300">Trusted by leading companies and professionals worldwide</p>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 opacity-70">
            ...
            <div className="flex items-center space-x-1 md:space-x-2">
              ...
              <span className="text-base md:text-xl font-bold text-gray-600 dark:text-gray-300">bolt.new</span>
            </div>
            ...
            <div className="flex items-center space-x-1 md:space-x-2">
              ...
              <span className="text-base md:text-xl font-bold text-gray-600 dark:text-gray-300">Supabase</span>
            </div>
            ...
            <div className="flex items-center space-x-1 md:space-x-2">
              ...
              <span className="text-base md:text-xl font-bold text-gray-600 dark:text-gray-300">Vercel</span>
            </div>
            ...
            <div className="flex items-center space-x-1 md:space-x-2">
              ...
              <span className="text-base md:text-xl font-bold text-gray-600 dark:text-gray-300">Next.js</span>
            </div>
            ...
            <div className="flex items-center space-x-1 md:space-x-2">
              ...
              <span className="text-base md:text-xl font-bold text-gray-600 dark:text-gray-300">Tailwind</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Verified Professionals</h3>
              <p className="text-gray-600 dark:text-gray-300">All professionals go through our comprehensive verification process</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Quality Ratings</h3>
              <p className="text-gray-600 dark:text-gray-300">Transparent review system to help you make informed decisions</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Team Formation</h3>
              <p className="text-gray-600 dark:text-gray-300">Build teams of professionals for larger, complex projects</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Growth Tracking</h3>
              <p className="text-gray-600 dark:text-gray-300">Monitor your project progress and professional development</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <Card key={index} className="text-center hover:shadow-md transition-shadow cursor-pointer bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600">
                <CardContent className="p-4">
                  <div className="text-sm font-medium text-gray-900 dark:text-white mb-1">{category.name}</div>
      ...
      <section className="py-20 bg-blue-600 dark:bg-blue-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base md:text-xl text-blue-100 dark:text-blue-200 mb-6 md:mb-8 max-w-2xl mx-auto">
