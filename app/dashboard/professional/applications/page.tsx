  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Track your job applications and responses</p>
      </div>
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-gray-500 text-sm mt-2">Your job applications will appear here.</p>
          </CardContent>
        </Card>
      ) : (
