      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your projects and track progress with professionals
          </p>
        </div>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <Link href={`/dashboard/hirer/projects/${project.id}`}>
                    ...
                    <div className="flex flex-col space-y-3">
                      <div className="flex items-center space-x-3">
                        <Avatar className="h-10 w-10">
                          <AvatarImage src={project.professional?.avatar_url} alt={project.professional?.first_name || ''} />
                          <AvatarFallback className="bg-blue-100 text-blue-700">
                            {project.professional?.first_name?.[0]}{project.professional?.last_name?.[0]}
                          </AvatarFallback>
                        </Avatar>
                        <div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <Link href="/dashboard/hirer/reports">
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-medium text-gray-900 mb-2">Find Professionals</h3>
              <p className="text-sm text-gray-600 mb-4">
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Communicate with professionals working on your projects
              </p>
              <Link href="/messages">
                <Button variant="outline" className="w-full">
                  View Messages
