        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  <span className="text-sm font-medium mr-2">
                    {statistics.category_averages.skills.toFixed(1)}
                  </span>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  <span className="text-sm font-medium mr-2">
                    {statistics.category_averages.communication.toFixed(1)}
                  </span>
                  <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                </div>
              </div>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  <span className="text-sm font-medium mr-2">
                    {statistics.category_averages.timeliness.toFixed(1)}
                  </span>
                  <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                </div>
              </div>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  <span className="text-sm font-medium mr-2">
                    {statistics.category_averages.professionalism.toFixed(1)}
                  </span>
                  <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                </div>
              </div>
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900 mb-1">
              {statistics.recommendation_percentage}%
            </div>
            <p className="text-sm text-gray-600">
              Would recommend this professional
            </p>
          </div>
        </div>
      </CardContent>
